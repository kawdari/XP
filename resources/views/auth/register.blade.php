                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="age" value="{{ old('number') }}" required autocomplete="number" autofocus>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6" >
                                            @foreach ($avatar as $item)
                                                ...
                                                <img src="{{asset('images/'.$item->src)}}" alt="" width="70" style="border-radius: 50%;">
                                                </div>
